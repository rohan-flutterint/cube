...
export class BaseTimeDimension extends BaseFilter {
  ...
  public dimensionSql() {
    ...
    const granularityInterval = this.isPredefined ? `1 ${granularity}` : this.granularityInterval;
